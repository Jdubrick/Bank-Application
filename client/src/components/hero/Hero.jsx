...
import { GetStarted } from "../exports";

function Hero() {
  return (
    <section
      id="home"
      className={`flex flex-col md:flex-row sm:py-16 py-6 max-w-7xl mx-auto`}
    >
      <div
        className={`flex-col flex-1 flex justify-center items-start px-6 sm:px-16 xl:px-0`}
      >
      ...
      <div className="relative flex flex-1 justify-center items-center my-10 md:my-0">
        <img
